...
COPY --from=builder --chown=nobody:root /app/_build/prod/rel/nous_spend ./

# copy the spending data into the runner image
COPY --chown=nobody:root data /app/bin/data
